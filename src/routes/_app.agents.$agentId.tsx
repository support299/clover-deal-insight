...
import { ArrowDown, ArrowUp, ArrowLeft, DollarSign, Hash, LineChart as LineChartIcon, Percent, TrendingUp, Wallet, Users } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <MetricCard title="Number of Sales" icon={Hash} value={m.numSales.toLocaleString()}
          delta={pctChange(m.numSales, mPrev.numSales)} sub="this period" />
          ...
          {loading ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={trend} margin={{ top: 5, right: 16, left: 0, bottom: 0 }}>
                ...
                />
                <Line type="monotone" dataKey="revenue" stroke="url(#grad-agent)" strokeWidth={2.5} dot={false} activeDot={{ r: 4 }} />
              </LineChart>
            </ResponsiveContainer>
          )}
        </div>
            ...
            <tbody>
              ...
              {!loading && pageRows.length === 0 && (
                <tr><td colSpan={7} className="px-4 py-12 text-center text-sm text-muted-foreground">
                  No sales for this agent in the selected range.
                </td></tr>
              )}
            </tbody>
          </table>
