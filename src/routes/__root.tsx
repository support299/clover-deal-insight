...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pinnacle Wellness Group Dashboard" },
      { name: "twitter:title", content: "Pinnacle Wellness Group Dashboard" },
      { property: "og:description", content: "Pinnacle Wellness Group sales dashboard — track sales, monitor team performance, and climb the leaderboards." },
      { name: "twitter:description", content: "Pinnacle Wellness Group sales dashboard — track sales, monitor team performance, and climb the leaderboards." },
