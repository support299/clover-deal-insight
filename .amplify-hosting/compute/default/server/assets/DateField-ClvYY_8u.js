...
import { e as cn, f as buttonVariants, B as Button } from "./router-CvBcNStb.js";
...
function DateField({ label, value, onChange, min, max }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
    /* @__PURE__ */ jsx("label", { className: "mb-1.5 block text-xs uppercase tracking-wider text-muted-foreground", children: label }),
      ...
      /* @__PURE__ */ jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
        Button,
        {
          ...
          children: [
            ...
            value ? format(value, "PPP") : /* @__PURE__ */ jsx("span", { children: "Pick a date" })
          ]
        }
      ) }),
